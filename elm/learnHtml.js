...
var $author$project$LearnHtml$init = {inputText: '', words: _List_Nil};
...
var $author$project$LearnHtml$parseText = function (input) {
	return A2(
		$elm$core$List$filter,
		A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
		A2($elm$core$String$split, ' ', input));
};
var $author$project$LearnHtml$update = F2(
	function (msg, model) {
		if (msg.$ === 'UpdateText') {
			var newText = msg.a;
			...
			return _Utils_update(
				model,
				{
					words: $author$project$LearnHtml$parseText(model.inputText)
				});
		}
	});
var $author$project$LearnHtml$ParseWords = {$: 'ParseWords'};
var $author$project$LearnHtml$UpdateText = function (a) {
...
var $author$project$LearnHtml$main = $elm$browser$Browser$sandbox(
	{init: $author$project$LearnHtml$init, update: $author$project$LearnHtml$update, view: $author$project$LearnHtml$view});
_Platform_export({'LearnHtml':{'init':$author$project$LearnHtml$main(
